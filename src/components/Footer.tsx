...
export default function Footer() {
  return (
    <footer className="w-full footer-glass py-[20px] border-t border-white/10 flex flex-col sm:flex-row items-center justify-between px-6 md:px-12 gap-4 shadow-lg text-sm shrink-0">
